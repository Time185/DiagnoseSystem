...
* While developing it is easy to use `gulp` default task with watch. Just run it and go to [http://10.15.0.10:8080/test/runner.html](http://10.15.0.10:8080/test/runner.html). After src file change konva-dev.js will be automatically created, so you just need refresh test the page.
