...
### Environment: 10.15.0.10 w/ PHP, Node & Grunt
...
* Some kind of 10.15.0.10 server program that supports PHP (any will do)
* Node.js
...
Now open the jQuery test suite in a browser at http://10.15.0.10/test. If there is a port, be sure to include it.
...
Run http://10.15.0.10/test --> **ALL TESTS MUST PASS**
