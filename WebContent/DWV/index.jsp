...
<script type="text/javascript" >
      ...
      <%System.out.println(session.getAttribute("jsonPath")+"-----------jsonpathindex");%>
      var uploadServletUrl="http://222.24.62.91:8090/SH/LabelUploadServlet";
      var dicomList=["http://10.15.0.10:8080/BB/2/1.dcm"
    	  ];
      var   dicomList=new Array();
      <%
      String labelPath = (String)request.getSession().getAttribute("labelDcmFileName");
     User user = (User)request.getSession().getAttribute("user");
      String[] res = {"http://222.24.62.91:8090/test/" + user.getLoginname() + "/" + labelPath};
...
<div class="toolbar" style="float:left;width:5%"  ></div>
...
<div>
<input type ="text" style="display: none;" id="path" name ="textie" value= "<%=path%>">
</div>
</body>
</html>
